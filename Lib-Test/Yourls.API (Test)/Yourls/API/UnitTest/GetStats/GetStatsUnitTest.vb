  ...
  Public Class GetStatsUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Ex = Service.GetStats(Authentication := MyAuth, Filter := eYourlsFilter.Top, Limit := 34, Result := Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = Response.ToException()
          Else
            Me.m_Result = Helper(Of YourlsGetStatsResult).CheckResult("GetStats", Me.Ex, Response, TreatSoftFailAsFail := False)
          End If
        End If
      End If
