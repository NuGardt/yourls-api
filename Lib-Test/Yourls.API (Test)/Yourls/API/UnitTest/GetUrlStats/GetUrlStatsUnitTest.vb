...
Namespace Yourls.API.UnitTest.GetUrlStats
  Public Class GetUrlStatsUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Ex = Service.GetUrlStats(ShortUrl := "http://ls.nugardt.com/2go8s", Authentication := MyAuth, Result := Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = Response.ToException()
          Else
            Me.m_Result = Helper(Of YourlsGetUrlStatsResult).CheckResult("GetUrlStats", Me.Ex, Response, TreatSoftFailAsFail := False)
          End If
        End If
      End If
