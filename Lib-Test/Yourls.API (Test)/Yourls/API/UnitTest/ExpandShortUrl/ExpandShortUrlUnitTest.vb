...
Namespace Yourls.API.UnitTest.ExpandShortUrl
  Public Class ExpandShortUrlUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Ex = Service.ExpandShortUrl(ShortUrl := "http://ls.nugardt.com/2go8s", Authentication := MyAuth, Result := Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = Response.ToException()
          Else
            Me.m_Result = Helper(Of YourlsExpandShortUrlResult).CheckResult("ExpandShortUrl", Me.Ex, Response, TreatSoftFailAsFail := False)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "YOURLS API: ExpandShortUrl"
      End Get
    End Property
