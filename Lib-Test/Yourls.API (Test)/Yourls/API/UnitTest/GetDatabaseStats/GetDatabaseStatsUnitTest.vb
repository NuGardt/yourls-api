...
Namespace Yourls.API.UnitTest.GetDatabaseStats
  Public Class GetDatabaseStatsUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Ex = Service.GetDatabaseStats(Authentication := MyAuth, Result := Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = Response.ToException()
          Else
            Me.m_Result = Helper(Of YourlsGetDatabaseStatsResult).CheckResult("GetDatabaseStats", Me.Ex, Response, TreatSoftFailAsFail := False)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "YOURLS API: GetDatabaseStats"
      End Get
    End Property
