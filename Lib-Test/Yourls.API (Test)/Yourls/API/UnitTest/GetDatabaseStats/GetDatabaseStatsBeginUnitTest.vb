...
Namespace Yourls.API.UnitTest.GetDatabaseStats
  Public Class GetDatabaseStatsBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetDatabaseStatsBegin(Nothing, MyAuth, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      ...
      Me.Ex = Me.Service.GetDatabaseStatsEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = Response.ToException()
        Else
          Me.m_Result = Helper(Of YourlsGetDatabaseStatsResult).CheckResult("GetDatabaseStatsBegin", Me.Ex, Response, TreatSoftFailAsFail := False)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "YOURLS API: GetDatabaseStatsBegin"
      End Get
    End Property
